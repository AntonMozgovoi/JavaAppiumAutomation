...
public class SearchPageObject extends MainPageObject{
    ...
    private static final String
            ...
            SEARCH_RESULT_LIST = "//*[@resource-id='org.wikipedia:id/search_results_list']"; // список поиска
    ...
    {
       this.waitForElementPresent(By.id(SEARCH_CANCEL_BUTTON), "Cannot find search cancel element",5);
    }
    ...
    {
        this.waitForElementNotPresent(By.id(SEARCH_RESULT_ELEMENT), "Search list is still visible",5);
    }
    ...
    {
        this.waitForElementPresent(
                By.xpath(SEARCH_EMPTY_RESULT_ELEMENT),"Cannot find empty results by element(Невозможно найти пустой результат)",15);
    }
    ...
    {
        this.waitForElementPresent(
                By.xpath(SEARCH_RESULT_LIST),"Cannot find search result list",15);
    }
}
